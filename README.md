...
| `packages/data` | The dataset (37 services, 359 endpoints, 150 connections — 138 of them discovery-verified — 48 flows, 8 domains, 12 teams) + referential-integrity test suite |
